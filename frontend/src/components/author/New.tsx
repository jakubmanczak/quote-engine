...
export const NewAuthor = () => {
  return (
    <div className="w-80 rounded-md border-2 border-sidebar border-dashed flex justify-center items-center hover:bg-sidebar cursor-pointer overflow-clip relative">
